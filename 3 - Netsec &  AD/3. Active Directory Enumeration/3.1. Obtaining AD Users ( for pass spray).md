...
```shell-session
$ kerbrute userenum -d ad.someorg.local --dc 172.16.5.5 jsmith.txt -o valid_ad_users.txt

2021/11/17 23:01:46 >  Using KDC(s):
2021/11/17 23:01:46 >   172.16.5.5:88
2021/11/17 23:01:46 >  [+] VALID USERNAME:       jjones@ad.someorg.local
2021/11/17 23:01:46 >  [+] VALID USERNAME:       sbrown@ad.someorg.local
```
...
cn: Htb Student
userPrincipalName: htb-student@ad.someorg.local

cn: Annie Vazquez
userPrincipalName: avazquez@ad.someorg.local
<SNIP>
```
...
2022/02/17 22:16:11 >  [+] VALID USERNAME:	 jjones@ad.someorg.local
2022/02/17 22:16:11 >  [+] VALID USERNAME:	 sbrown@ad.someorg.local
2022/02/17 22:16:11 >  [+] VALID USERNAME:	 tjohnson@ad.someorg.local
<SNIP>
```
