...
- [ ] Collect users (`nxc smb --users`, `rpcclient enumdomusers`) Kerbrute
- [ ] attempt ASREPRoasting valid users kerbrute --downgrade
- [ ] attempt blind kerberoasting ![[Pasted image 20251005222905.png]]
...
### last resort /cooking
- [ ] Lnk bomb,
- [ ] if server version is 2016 try SCF file share attack
- [ ] test out windows AD exploits like 
- [ ] petitpotam, 
- [ ] PrintNightmare
- [ ] NoPac
- [ ] AD CS ESC8 relay
